...
from Cocoamphoactate.recommendation_engine.recommendations import Engine, FRIENDS_ONLY, ALL_USERS
from rest_framework.authtoken.models import Token
from django.test import Client
from Cocoamphoactate.models import User, Score, Game, Friends
